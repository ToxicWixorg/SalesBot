...
export const en = {
	...
	orderCryptoProofInstructions:
		`${e.clipboard} <b>Payment steps:</b>\n\n` +
		`1. Send the exact amount to the address above\n` +
		`2. Then send the transaction hash (TxID) or a receipt photo here\n` +
		`3. Your order is processed after an admin reviews and approves it`,
	orderZarinpalProofInstructions:
		`${e.clipboard} <b>Payment steps:</b>\n\n` +
		`1. Tap "Pay" and complete the payment\n` +
		`2. Then send the tracking code or a receipt photo here\n` +
		`3. Your order is processed after an admin reviews and approves it`,
	orderProofExpect: `${e.reject} Please send the transaction hash (text) or a payment receipt photo.`,
	...
	enterOrderQuantityPrompt: `${e.trolley} How many of this product would you like?\n\nPlease enter the quantity as a number:`,
