...
${payload.ids}`,
	...
	orderCryptoProofInstructions:
		`${e.clipboard} <b>دستورالعمل پرداخت:</b>\n\n` +
		`۱. مبلغ رو دقیقاً به آدرس بالا ارسال کن\n` +
		`۲. سپس هش تراکنش (TxID) یا عکس رسید رو همینجا بفرست\n` +
		`۳. سفارشت پس از بررسی و تأیید ادمین پردازش می‌شه`,
	orderZarinpalProofInstructions:
		`${e.clipboard} <b>دستورالعمل پرداخت:</b>\n\n` +
		`۱. روی دکمه «پرداخت» بزن و مبلغ رو پرداخت کن\n` +
		`۲. سپس کد رهگیری یا عکس رسید رو همینجا بفرست\n` +
		`۳. سفارشت پس از بررسی و تأیید ادمین پردازش می‌شه`,
	orderProofExpect: `${e.reject} لطفاً هش تراکنش (متن) یا عکس رسید پرداخت رو بفرست.`,
	...
	rechargeUsdtRate: (rate: string) => `📈 نرخ لحظه‌ای: <b>${rate}</b> USD/USDT`,
	...
	paymentQuantity: "تعداد",
	enterOrderQuantityPrompt: `${e.trolley} چند عدد از این محصول می‌خوای؟\n\nلطفاً تعداد رو به عدد وارد کن:`,
	...
	btnPlanRequirements: "📋 فیلدهای ورودی",
	btnPlanOrder: "🔢 ترتیب",
	btnPlanActivate: "✅ فعال‌سازی",
	btnPlanDeactivate: "🚫 غیرفعال‌سازی",
	btnPlanAddField: "➕ افزودن فیلد",
	adminPlanAddFieldPromptFA:
		"➕ افزودن فیلد ورودی جدید.\n\nمتن فیلد را به <b>فارسی</b> بفرستید (سؤالی که هنگام خرید از کاربر پرسیده می‌شود).\n/cancel برای لغو.",
	adminPlanAddFieldPromptEN: "حالا متن همان فیلد را به <b>انگلیسی</b> بفرستید.",
	adminPlanAddFieldPromptRU: "حالا متن همان فیلد را به <b>روسی</b> بفرستید.",
	adminPlanAddFieldCancelled: "❌ افزودن فیلد لغو شد.",
	...
	adminPlanRequirementsTitle:
		"📋 فیلدهای ورودی این پلن (هنگام خرید از کاربر پرسیده می‌شوند).\nبرای حذف روی هر فیلد بزنید، یا فیلد جدید اضافه کنید:",
